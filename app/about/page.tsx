      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start mb-8">
          ...
          <div className="flex-1">
            <p className="text-lg text-neutral-700 dark:text-white mb-6">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h3 className="font-medium text-neutral-900 dark:text-white mb-2">Security Domains</h3>
              <ul className="text-sm text-neutral-600 dark:text-white space-y-1">
            ...
            <div>
              <h3 className="font-medium text-neutral-900 dark:text-white mb-2">Technologies</h3>
              <ul className="text-sm text-neutral-600 dark:text-white space-y-1">
          ...
          <ul className="text-neutral-600 dark:text-white space-y-2">
