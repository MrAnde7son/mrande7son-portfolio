    ...
    <section className="space-y-12">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1">
          <h1 className="mb-6 text-3xl font-semibold tracking-tighter">Itamar Mizrahi</h1>
          ...
          <p className="text-neutral-600 dark:text-neutral-400">In my free time, I like surfing and traveling</p>
        </div>
      </div>
